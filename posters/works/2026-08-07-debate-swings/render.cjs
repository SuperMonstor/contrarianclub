// Re-export the nine swing slides from swing.html.
//
//   cd posters && node works/2026-08-07-debate-swings/render.cjs
//
// swing.html is self-contained (fonts and the logo are inlined as data URIs),
// so this needs nothing but Playwright from the studio's own dependencies.
// Each .slot is pinned to its native 1600x900 and shot at 2x, giving 3200x1800.
...
(async () => {
  ...
  await page.goto("file://" + path.join(DIR, "swing.html"));
