...
import { Promo, type PromoCopy } from "./slides";

// Image-forward promo for the Community Open Debate. Full-bleed painting of
// the Roman senate mid-debate (Maccari, "Cicero Denounces Catiline", public
// domain). The layout is in slides.tsx.
  ...
  slides: [
    {
      label: "Promo",
      hasImage: true,
      render: ({ format }) => <Promo copy={copy} format={format} />,
    },
  ],
};
