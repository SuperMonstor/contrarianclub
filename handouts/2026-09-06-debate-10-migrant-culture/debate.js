...
const DEBATE = {
  ...
  terms: [
    ...
    ["The right to reshape",
     "To change what the culture is: what you bring to it, what you decline to take up, and what you expect of the people already here. The motion covers all three. Who has the right, not what will happen."],
  ],

  // Name the common ground first, then the one question the evening turns on.
  agreed: "Someone who moves here can go years without the language or the local norms and get by, because the people here are tolerant and willing to adapt. No one is arguing that the local language and customs should go.",
  split: "How far should the city move towards the languages and festivals migrants bring, and how far should migrants move towards what is already here?",

  // Where each bench starts. Optional: delete the key and the block does not
  // draw.
  benches: [
    ["For the motion", "A city's culture is a living thing, made by the people living in it, not a fixed inheritance. Someone who moves in can influence it and respect what is already here at the same time."],
    ["Against", "Tolerance has a limit, and it is not giving up your own language. People here are within their rights to insist on their language and norms, on signboards and in what the city celebrates."],
  ],
